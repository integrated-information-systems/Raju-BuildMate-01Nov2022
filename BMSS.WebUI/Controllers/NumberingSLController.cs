...
{
    public class NumberingSLController : Controller
    {
        private AjaxFormViewModel ajaxFormViewModel = new AjaxFormViewModel()
        {
            FormAddAction = "AddNumberingSL",
            AddActionTargetId = "NumberingSLListTble",
            AddFormId = "NumberingSLAddForm",
            FormDeleteAction = "DeleteNumberingSL",
            DeleteActionTargetId = "NumberingSLListTble",
            DeleteFormId = "NumberingSLDeleteForm",
            FormEditAction = "EditNumberingSL",
            EditActionTargetId = "NumberingSLListTble",
            EditFormId = "NumberingSLEditForm",
            FormUpdateAction = "AddNumberingSL",
            UpdateActionTargetId = "NumberingSLListTble",
            UpdateFormId = "NumberingSLAddForm",
            ModalID = "AddUpdateNumberingSLModal"
        };
        //Repositories
        private I_Numbering_Repository i_Numbering_Repository;
        IMapper _mapper;

        public NumberingSLController([NumSL] I_Numbering_Repository i_Numbering_Repository, IMapper _mapper)
        {
        ...
        public ActionResult AddNumberingSL(AddUpdateDocNumberingViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.NumberingID == 0)
                {
                    ...
                    {
                        NumberingSL NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingSL>(model);
                ...
                else
                {
                    ...
                    NumberingSL NumberingObject = (NumberingSL)i_Numbering_Repository.GetNumbering(model.NumberingID);
                    if (NumberingObject != null)
                    {
                        if (NumberingObject.IsLocked.Equals(false))
                        {
                            ...
                            else
                            {
                                ...
                                NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingSL>(model);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult EditNumberingSL(int NumberingID)
        {
            ...
            if (ModelState.IsValid)
            {
                NumberingSL NumberingObject = (NumberingSL)i_Numbering_Repository.GetNumbering(NumberingID);
                if (NumberingObject != null)
                {
                    if (NumberingObject.IsLocked.Equals(false))
                    {
                        EditNumberingModel = _mapper.Map<NumberingSL, AddUpdateDocNumberingViewModel>(NumberingObject);
                    }
                    else
                    {
                        ErrList.Add("Series already locked, cannot proceed");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult DeleteNumberingSL(int NumberingID)
        {
            JsonResultViewModel jsonResultViewModel = new JsonResultViewModel() { };
