...
{
    public class NumberingSIController : Controller
    {
        private AjaxFormViewModel ajaxFormViewModel = new AjaxFormViewModel()
        {
            FormAddAction = "AddNumberingSI",
            AddActionTargetId = "NumberingSIListTble",
            AddFormId = "NumberingSIAddForm",
            FormDeleteAction = "DeleteNumberingSI",
            DeleteActionTargetId = "NumberingSIListTble",
            DeleteFormId = "NumberingSIDeleteForm",
            FormEditAction = "EditNumberingSI",
            EditActionTargetId = "NumberingSIListTble",
            EditFormId = "NumberingSIEditForm",
            FormUpdateAction = "AddNumberingSI",
            UpdateActionTargetId = "NumberingSIListTble",
            UpdateFormId = "NumberingSIAddForm",
            ModalID = "AddUpdateNumberingSIModal"
        };
        //Repositories
        private I_Numbering_Repository i_Numbering_Repository;
        IMapper _mapper;

        public NumberingSIController([NumSI] I_Numbering_Repository i_Numbering_Repository, IMapper _mapper)
        {
        ...
        public ActionResult AddNumberingSI(AddUpdateDocNumberingViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.NumberingID == 0)
                {
                    ...
                    {
                        NumberingSI NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingSI>(model);
                ...
                else
                {
                    ...
                    NumberingSI NumberingObject = (NumberingSI)i_Numbering_Repository.GetNumbering(model.NumberingID);
                    if (NumberingObject != null)
                    {
                        if (NumberingObject.IsLocked.Equals(false))
                        {
                            ...
                            else
                            {
                                ...
                                NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingSI>(model);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult EditNumberingSI(int NumberingID)
        {
            ...
            if (ModelState.IsValid)
            {
                NumberingSI NumberingObject = (NumberingSI)i_Numbering_Repository.GetNumbering(NumberingID);
                if (NumberingObject != null)
                {
                    if (NumberingObject.IsLocked.Equals(false))
                    {
                        EditNumberingModel = _mapper.Map<NumberingSI, AddUpdateDocNumberingViewModel>(NumberingObject);
                    }
                    else
                    {
                        ErrList.Add("Series already locked, cannot proceed");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult DeleteNumberingSI(int NumberingID)
        {
            JsonResultViewModel jsonResultViewModel = new JsonResultViewModel() { };
