...
{
    public class NumberingGRNController : Controller
    {
        private AjaxFormViewModel ajaxFormViewModel = new AjaxFormViewModel()
        {
            FormAddAction = "AddNumberingGRN",
            AddActionTargetId = "NumberingGRNListTble",
            AddFormId = "NumberingGRNAddForm",
            FormDeleteAction = "DeleteNumberingGRN",
            DeleteActionTargetId = "NumberingGRNListTble",
            DeleteFormId = "NumberingGRNDeleteForm",
            FormEditAction = "EditNumberingGRN",
            EditActionTargetId = "NumberingGRNListTble",
            EditFormId = "NumberingGRNEditForm",
            FormUpdateAction = "AddNumberingGRN",
            UpdateActionTargetId = "NumberingGRNListTble",
            UpdateFormId = "NumberingGRNAddForm",
            ModalID = "AddUpdateNumberingGRNModal"
        };
        //Repositories
        private I_Numbering_Repository i_Numbering_Repository;
        IMapper _mapper;

        public NumberingGRNController([NumGRN] I_Numbering_Repository i_Numbering_Repository, IMapper _mapper)
        {
        ...
        public ActionResult AddNumberingGRN(AddUpdateDocNumberingViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.NumberingID == 0)
                {
                    ...
                    {
                        NumberingGRN NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingGRN>(model);
                ...
                else
                {
                    ...
                    NumberingGRN NumberingObject = (NumberingGRN)i_Numbering_Repository.GetNumbering(model.NumberingID);
                    if (NumberingObject != null)
                    {
                        if (NumberingObject.IsLocked.Equals(false))
                        {
                            ...
                            else
                            {
                                ...
                                NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingGRN>(model);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult EditNumberingGRN(int NumberingID)
        {
            ...
            if (ModelState.IsValid)
            {
                NumberingGRN NumberingObject = (NumberingGRN)i_Numbering_Repository.GetNumbering(NumberingID);
                if (NumberingObject != null)
                {
                    if (NumberingObject.IsLocked.Equals(false))
                    {
                        EditNumberingModel = _mapper.Map<NumberingGRN, AddUpdateDocNumberingViewModel>(NumberingObject);
                    }
                    else
                    {
                        ErrList.Add("Series already locked, cannot proceed");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult DeleteNumberingGRN(int NumberingID)
        {
            JsonResultViewModel jsonResultViewModel = new JsonResultViewModel() { };
