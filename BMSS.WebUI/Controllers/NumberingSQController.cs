...
{
    public class NumberingSQController : Controller
    {
        private AjaxFormViewModel ajaxFormViewModel = new AjaxFormViewModel()
        {
            FormAddAction = "AddNumberingSQ",
            AddActionTargetId = "NumberingSQListTble",
            AddFormId = "NumberingSQAddForm",
            FormDeleteAction = "DeleteNumberingSQ",
            DeleteActionTargetId = "NumberingSQListTble",
            DeleteFormId = "NumberingSQDeleteForm",
            FormEditAction = "EditNumberingSQ",
            EditActionTargetId = "NumberingSQListTble",
            EditFormId = "NumberingSQEditForm",
            FormUpdateAction = "AddNumberingSQ",
            UpdateActionTargetId = "NumberingSQListTble",
            UpdateFormId = "NumberingSQAddForm",
            ModalID = "AddUpdateNumberingSQModal"
        };
        //Repositories
        private I_Numbering_Repository i_Numbering_Repository;
        IMapper _mapper;

        public NumberingSQController([NumSQ] I_Numbering_Repository i_Numbering_Repository, IMapper _mapper)
        {
        ...
        public ActionResult AddNumberingSQ(AddUpdateDocNumberingViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.NumberingID == 0)
                {
                    ...
                    else if (model.FirstNo >= model.LastNo)
                    {
                        ...
                        NumberingSQ NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingSQ>(model);
                ...
                else
                {
                    ...
                    NumberingSQ NumberingObject = (NumberingSQ)i_Numbering_Repository.GetNumbering(model.NumberingID);
                    if (NumberingObject != null)
                    {
                        ...
                        {                       
                            ...
                            else
                            {
                                    ...
                                    NumberingObject = _mapper.Map<AddUpdateDocNumberingViewModel, NumberingSQ>(model);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult EditNumberingSQ(int NumberingID)
        {
            ...
            if (ModelState.IsValid)
            {
                NumberingSQ NumberingObject = (NumberingSQ)i_Numbering_Repository.GetNumbering(NumberingID);
                if (NumberingObject != null)
                {
                    if (NumberingObject.IsLocked.Equals(false))
                    {
                        EditNumberingModel = _mapper.Map<NumberingSQ, AddUpdateDocNumberingViewModel>(NumberingObject);
                    }
                    else
                    {
                        ErrList.Add("Series already locked, cannot proceed");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken()]
        public ActionResult DeleteNumberingSQ(int NumberingID)
        {
            JsonResultViewModel jsonResultViewModel = new JsonResultViewModel() { };
