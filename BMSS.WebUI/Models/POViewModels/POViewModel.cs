...
namespace BMSS.WebUI.Models.POViewModels
{
    public class POViewModel
    {
        ...
        [JsonProperty(PropertyName = "copiedGRPO")]
        [Display(Name = "Copied to PDN")]
        [ReadOnly(true)]
        public string CopiedGRPO { get; set; }
        ...
        public List<POLineViewModel> Lines { get; set; }
        [JsonProperty(PropertyName = "noteLines")]
        public List<PONoteViewModel> NoteLines { get; set; }
    }
}