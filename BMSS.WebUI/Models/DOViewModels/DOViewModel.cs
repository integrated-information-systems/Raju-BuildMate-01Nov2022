...
namespace BMSS.WebUI.Models.DOViewModels
{
    public class DOViewModel
    {
        ...
        [JsonProperty(PropertyName = "copiedSQ")]
        [Display(Name = "Copied from SQ")]
        [ReadOnly(true)]
        public string CopiedSQ { get; set; }
        ...
        [JsonProperty(PropertyName = "haveStockLoan")]
        public bool HaveStockLoan { get; set; }
        ...
        public List<DOLineViewModel> Lines { get; set; }
        [JsonProperty(PropertyName = "noteLines")]
        public List<DONoteViewModel> NoteLines { get; set; }
