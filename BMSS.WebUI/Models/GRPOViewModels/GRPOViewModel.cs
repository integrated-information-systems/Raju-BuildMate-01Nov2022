...
namespace BMSS.WebUI.Models.GRPOViewModels
{
    public class GRPOViewModel
    {
        ...
        [JsonProperty(PropertyName = "pORNo")]
        [MaxLength(20)]
        ...
        public List<GRPOLineViewModel> Lines { get; set; }
        [JsonProperty(PropertyName = "noteLines")]
        public List<GRPONoteViewModel> NoteLines { get; set; }
    }
}