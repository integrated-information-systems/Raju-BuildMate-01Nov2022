...
namespace BMSS.WebUI.Models.CashSalesCreditViewModels
{
    public class CashSalesCreditViewModel
    {
        ...
        [JsonProperty(PropertyName = "sRINo")]
        [Display(Name = "SRI #")]
        [MaxLength(100)]
        [Required]
        ...
        public List<CashSalesCreditLineViewModel> Lines { get; set; }
        [JsonProperty(PropertyName = "noteLines")]
        public List<CashSalesCreditNoteViewModel> NoteLines { get; set; }
        [JsonProperty(PropertyName = "payLines")]
        public List<CashSalesCreditPayViewModel> PayLines { get; set; }
    }
}