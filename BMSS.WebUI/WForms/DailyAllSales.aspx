<%@ Page Title="" Language="C#" MasterPageFile="~/WForms/Site.Master" AutoEventWireup="true" CodeBehind="DailyAllSales.aspx.cs" Inherits="BMSS.WebUI.WForms.DailyAllSales" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHeader" runat="server">
    <section class="content-header">
        <h1 id="`">
           Daily All Sales
            <small>Daily All Sales Report</small>
        </h1>        
    </section>
</asp:Content>
