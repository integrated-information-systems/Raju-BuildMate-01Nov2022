<%@ Page Title="" Language="C#" MasterPageFile="~/WForms/Site.Master" AutoEventWireup="true" CodeBehind="MonthlyCollectionByCustomer.aspx.cs" Inherits="BMSS.WebUI.WForms.MonthlyCollectionByCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHeader" runat="server">
    <section class="content-header">
        <h1 id="`">
           Monthly Collection by Customer
            <small>Monthly Collection Report</small>
        </h1>        
    </section>
</asp:Content>
