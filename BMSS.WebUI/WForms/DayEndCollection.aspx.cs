...
{
    public partial class DayEndCollection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                string ReportFileName = Server.MapPath("~\\App_Data\\Day End Collection Report.rpt");
                ...
                if (Session["CardCodeFr"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("@CardCodeFr", Session["CardCodeFr"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("@CardCodeFr", "");
                    Session["CardCodeFr"] = "";
                }

                if (Session["CardCodeTo"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("@CardCodeTo", Session["CardCodeTo"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("@CardCodeTo", "");
                    Session["CardCodeTo"] = "";
                }


                if (Session["SalesPersonFr"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("@SlpNameFr", Session["SalesPersonFr"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("@SlpNameFr", "");
                    Session["SalesPersonFr"] = "";
                }
                if (Session["SalesPersonTo"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("@SlpNameTo", Session["SalesPersonTo"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("@SlpNameTo", "");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("@CardCodeFr", CardCodeFrom.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("@CardCodeTo", CardCodeTo.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("@SlpNameFr", SalesPersonFrom.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("@SlpNameTo", SalesPersonTo.SelectedValue);
