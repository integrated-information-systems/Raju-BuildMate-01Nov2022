...
{
    public partial class CSViewer : System.Web.UI.Page
    {
        public string URL = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                string DocNum =  i_CashSalesDocH_Repository.UpdatePrintStatus(DocEntry, User.Identity.Name);
                string pdfFileName = "BM_DO" + "_" + DocNum + "_" + DateTime.Now.ToString("ddMMyy") + ".pdf";

                URL = baseUrl + "WForms/ViewerPrint.aspx?DE=" + DocNum + "&Ty=" + BMSS.WebUI.Models.General.PrintDocTypes.Cash_Sales;
                ReportDocument cryRpt = new ReportDocument();
                cryRpt.Load(Server.MapPath("~\\App_Data\\Delivery_Order_Cash_Sale.rpt"));
                ...
                {
                    expCryRpt.Load(Server.MapPath("~\\App_Data\\Delivery_Order_Cash_Sale.rpt"));
