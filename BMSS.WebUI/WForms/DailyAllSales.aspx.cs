...
{
    public partial class DailyAllSales : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                string ReportFileName = Server.MapPath("~\\App_Data\\Daily All Sales.rpt");
                ...
                if (Session["FromDate"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("@DateFr", Session["FromDate"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("@DateFr", DateTime.Now);
                    Session["FromDate"] = DateTime.Now;
                }

                if (Session["ToDate"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("@DateTo", Session["ToDate"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("@DateTo", DateTime.Now);
                    Session["ToDate"] = DateTime.Now;
                }
                if (Session["CardCodeFr"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeFr@select * from ocrd", Session["CardCodeFr"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeFr@select * from ocrd", "");
                    Session["CardCodeFr"] = "";
                }

                if (Session["CardCodeTo"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeTo@select * from ocrd", Session["CardCodeTo"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeTo@select * from ocrd", "");
                    Session["CardCodeTo"] = "";
                }


                if (Session["SalesPersonFr"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("SalesPersonFr@Select SlpName from OSLP", Session["SalesPersonFr"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("SalesPersonFr@Select SlpName from OSLP", "");
                    Session["SalesPersonFr"] = "";
                }
                if (Session["SalesPersonTo"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("SalesPersonTo@Select SlpName From OSLP", Session["SalesPersonTo"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("SalesPersonTo@Select SlpName From OSLP", "");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("@DateFr", DocDateFrom.Text.Trim());
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("@DateTo", DocDateTo.Text.Trim());
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeFr@select * from ocrd", CardCodeFrom.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeTo@select * from ocrd", CardCodeTo.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("SalesPersonFr@Select SlpName From OSLP", SalesPersonFrom.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("SalesPersonTo@Select SlpName From OSLP", SalesPersonTo.SelectedValue);
