...
{
    public partial class SQViewer : System.Web.UI.Page
    {
        public string URL = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                I_SQDocH_Repository i_SQDocH_Repository = new EF_SQDocHeader_Repository();
                string DocNum = i_SQDocH_Repository.UpdatePrintStatus(DocEntry, User.Identity.Name);
                string pdfFileName = BMSS.WebUI.Models.General.PrintDocTypes.Sales_Quotation + "_" + DocNum + "_" + DateTime.Now.ToString("ddMMyy") + ".pdf";
                URL = baseUrl + "WForms/ViewerPrint.aspx?DE=" + DocNum + "&Ty=" + BMSS.WebUI.Models.General.PrintDocTypes.Sales_Quotation;
                ReportDocument cryRpt = new ReportDocument();
                cryRpt.Load(Server.MapPath("~\\App_Data\\Sales_Quotation.rpt"));
                ...
                {
                    expCryRpt.Load(Server.MapPath("~\\App_Data\\Sales_Quotation.rpt"));
