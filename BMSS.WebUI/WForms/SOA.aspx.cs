    ...
    public partial class SOA : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                string ReportFileName = Server.MapPath("~\\App_Data\\SOA.rpt");
                ...
                if (Session["FromDate"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("@AgeDateTo", Session["FromDate"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("@AgeDateTo", DateTime.Now);
                ...
                if (Session["CardCodeFr"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeFr@Select * from OCRD where cardtype = 'C'", Session["CardCodeFr"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeFr@Select * from OCRD where cardtype = 'C'", "");
                    Session["CardCodeFr"] = "";
                }

                if (Session["CardCodeTo"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeTo@Select * from OCRD where cardtype = 'C'", Session["CardCodeTo"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeTo@Select * from OCRD where cardtype = 'C'", "");
                    Session["CardCodeTo"] = "";
                }


                if (Session["SalesPersonFr"] != null)
                    crReportDocument.ReportDocument.SetParameterValue("SalesPerson@Select SlpName from OSLP", Session["SalesPersonFr"]);
                else
                {
                    crReportDocument.ReportDocument.SetParameterValue("SalesPerson@Select SlpName from OSLP", "");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("@AgeDateTo", DocDateFrom.Text.Trim());
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeFr@Select * from OCRD where cardtype = 'C'", CardCodeFrom.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("CardCodeTo@Select * from OCRD where cardtype = 'C'", CardCodeTo.SelectedValue);
                ...
                {
                    crReportDocument.ReportDocument.SetParameterValue("SalesPerson@Select SlpName from OSLP", SalesPersonFrom.SelectedValue);
