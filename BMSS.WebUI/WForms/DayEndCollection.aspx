<%@ Page Title="" Language="C#" MasterPageFile="~/WForms/Site.Master" AutoEventWireup="true" CodeBehind="DayEndCollection.aspx.cs" Inherits="BMSS.WebUI.WForms.DayEndCollection" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHeader" runat="server">
    <section class="content-header">
        <h1 id="`">
           Day End Collection
            <small>Day End Collection Report</small>
        </h1>        
    </section>
</asp:Content>
